                ...
                <div class="accordion accordion-flush filter-accordion">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xl-12">
                            <a href="#" data-url="{{ asset($value->papers) }}" id="urldynamic">
                                <div class="card border m-3">
                                    <img src="{{ asset($value->papers) }}" class="" alt="...">
                                    <div class="">
                                        <h5 class="text-muted text-center p-1">Page No. {{$value->sequence}}</h5>
                                    </div>
                                </div>
                            </a>
                        </div>
        ...
        <div class="col-xl-10 col-lg-8">
            <div class="card">
                <div class="card-header">
                    <div class="text-muted fst-italic">Published on : {{ date('j F, Y', strtotime($data->date)) }}</div>
                </div>
                <div class="card-body">
