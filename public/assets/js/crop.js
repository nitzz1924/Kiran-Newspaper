...
(function (y) {
    y.ImageCropper = function (z, y, E) {
        function A(b) {
            ...
            b
                ? B.setVals(b.x, b.y, b.w, b.h)
                : B.setVals(0, 0, c.width(), c.height());
            clearTimeout(G);
        ...
        function H(b, a, m, l) {
            ...
            0 < l
                ? (a.rotate((l / 180) * Math.PI),
                  180 === l
                      ? (a.translate(-b.width / 2, -b.height / 2),
                        a.drawImage(m, 0, 0, b.width, b.height),
                        a.translate(b.width / 2, b.height / 2))
                      : (a.translate(-b.height / 2, -b.width / 2),
                        a.drawImage(m, 0, 0, b.height, b.width),
                        a.translate(b.height / 2, b.width / 2)),
                  a.rotate((-l / 180) * Math.PI))
                : a.drawImage(
                      m,
        ...
        function O(b) {
            var a = n,
                ...
                k = [
                    r(l, a, 0, 0),
                    r(l, a, a - 1, 0),
                    r(l, a, a - 1, l.length / 4 / a - 1),
                    r(l, a, 0, l.length / 4 / a - 1),
                ];
            h = {};
            ...
            var k = 0,
                ...
                d;
            for (d in h)
                h.hasOwnProperty(d) && h[d] > k && ((k = h[d]), (g = d));
            g = g.split(",");
            h = g = {
                r: g[0],
                g: g[1],
        ...
        z = $(z);
        var u = $(
                '<div class="icrop-wrap"><canvas class="icrop-preview-canv"></canvas><div class="icrop-bg"></div><div class="icrop-box" style="position:absolute"><div class="icrop-clip-wrap"><canvas class="icrop-clip-canv"></canvas></div></div>'
            ),
            t = u.find(".icrop-box"),
            N = u.find(".icrop-bg"),
        ...
        f.getFinalDataUrl = function (b) {
            ...
            c[0]
                .getContext("2d")
                .drawImage(q[0], a.x, a.y, a.w, a.h, 0, 0, a.w, a.h);
            return c[0].toDataURL(b);
        };
        f.setVals = function (b) {
            var a =
                c.width() /
                (90 === e || 270 === e ? d.naturalHeight : d.naturalWidth);
            A({
                x: Math.round(b.x * a),
                y: Math.round(b.y * a),
                w: Math.round(b.w * a),
        ...
        f.getVals = function () {
            var b =
                    ...
                    c.width(),
                a =
                    (90 === e || 270 === e ? d.naturalWidth : d.naturalHeight) /
                    c.height(),
                f = B.getVals();
            return {
                x: Math.round(f.x * b),
...
(function (d, aa, v, D, ia) {
    ...
    function ba(a, b, c, e, u) {
        ...
        var p,
            ...
            v = function () {
                var C = +new Date();
                C - d < b && (!e || C - h < e) && !u
                    ? (p = setTimeout(v, b - (C - d)))
                    : ((p = null), c || ((g = a.apply(l, B)), (l = B = null)));
            };
        return function () {
            l = this;
            B = arguments;
    ...
    d.Dragger = function (a, b, c, d) {
            ...
            if (q) {
                ...
                1 === q &&
                    ...
                    C && 0 === w % 360
                        ? (0 > k ? (k = 0) : k + r > y && (k = y - r),
                          0 > m ? (m = 0) : m + t > x && (m = x - t))
                        : (k + r < g ? (k = g - r) : k > y - g && (k = y - g),
                          m + t < g ? (m = g - t) : m > x - g && (m = x - g)),
                    C ||
                        0 !== w % 180 ||
                        (3 > Math.abs(k)
                            ? (k = 0)
                            : 3 > Math.abs(k + r - y) && (k = y - r),
                        3 > Math.abs(m)
                            ? (m = 0)
                            : 3 > Math.abs(m + t - x) && (m = x - t)));
                if (10 === q) {
                    var b = n - F;
                    ...
                    0 < b && (a += 180);
                    b = (w - 360 * J) % 360;
                    -90 <= a && 0 > a && 270 >= b && 180 < b
                        ? J++
                        : -90 <= b && 0 > b && 270 >= a && 180 < a && J--;
                    w = a + 360 * J;
                    v();
                }
                a = 0 === w % 360;
                ...
                if (5 === q || 6 === q || 9 === q)
                    ...
                    (r = M + E),
                        ...
                        !C &&
                            ...
                            ((r = y - k), (f = 7 === q), (d = 3 !== q));
                G &&
                    (c && (b && (k += r - Math.round(G * t)), (r = G * t)),
                    d && (f && (m += t - Math.round(r / G)), (t = r / G)));
                a ||
                    1 === q ||
                    10 === q ||
                    ((a = k - P + (r - M) / 2),
        ...
        z.on("vmousedown", function (a) {
            ...
            Q &&
                ((q = $(this).hasClass("drag-rotate")
                    ? 10
                    : f.indexOf($(this).attr("data-dir")) + 2),
                p(a));
        });
        z.append(a);
    };
    ...
    (function (a, b, c, d) {
        ...
        function l(b, c, f) {
            ...
            if (m) {
                ...
                b = g.originalEvent;
                m = a.event.props;
                -1 < f.search(/^(mouse|click)/) && (m = t);
                if (b) for (p = m.length, l; p; ) (l = m[--p]), (g[l] = b[l]);
                -1 < f.search(/mouse(down|up)|click/) &&
                    !g.which &&
                    (g.which = 1);
                if (
                    -1 !== f.search(/^touch/) &&
                    ...
                    (f = l.touches),
                    (l = l.changedTouches),
                    (b = f && f.length ? f[0] : l && l.length ? l[0] : d))
                )
                    for (f = 0, m = r.length; f < m; f++)
                        (l = r[f]), (g[l] = b[l]);
        ...
        function Q(b) {
            if (!q) {
                ...
                (A =
                    A ||
                    Math.abs(c.pageX - G) > e ||
                    Math.abs(c.pageY - P) > e) &&
                    !d &&
                    l("vmousecancel", b, g);
                l("vmousemove", b, g);
                v();
        ...
        var r = "clientX clientY pageX pageY screenX screenY".split(" "),
            t = a.event.props.concat(
                a.event.mouseHooks ? a.event.mouseHooks.props : []
            ),
            w = {},
            J = 0,
            G = 0,
                ...
                function (b) {
                    ...
                    if (c)
                        for (
                            e = b.clientX,
                                g = b.clientY,
                                K = a.vmouse.clickDistanceThreshold,
                                h = d;
                            h;
...
(function () {
    ...
    $d.on("click", "#ic-crop-btn", function () {
        ...
        var a =
                "image/png" === $("#ic-download-type").val()
                    ? "image/png"
                    : "image/jpeg",
    ...
    $d.on("click", "#ic-download-btn", function () {
        ...
        this.href = c;
        this.download = a =
            (d ? d.name.split(".")[0] + "_cropped" : "cropped_image") +
            ("image/png" === a ? ".png" : ".jpg");
    });
